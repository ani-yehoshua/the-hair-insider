...
import { ArrowLeft, ArrowUpRight, Bookmark, BookmarkCheck, Calendar, Filter } from 'lucide-react';
...
export function GuideView({
  ...
  const stylingSteps = paidRoutine.filter(step => {
    const category = step.product.category.toLowerCase();
    return category.includes('styling') || category.includes('tool') || category.includes('heat protectant');
  });
  const washRhythm = {
    ...
    <div className="mx-auto w-full max-w-5xl px-5 pb-32 pt-12 md:px-8 md:pt-20 slide-up" data-testid="section-guide">
      ...
      <div className="max-w-3xl">
        ...
        <p className="mt-6 text-sm leading-relaxed text-foreground/80 md:text-base">
          This is your personalized length-retention guide. Your routine is structured to address <strong>{primaryCause}</strong> and protect your ends while avoiding <strong>{behaviorToStop}</strong>. Follow the exact cadences below to build a foundation for healthy growth.
        </p>
      </div>
      ...
      <div className="mt-16 rounded-2xl border border-foreground/15 bg-paper p-6 md:p-8" data-testid="daily-tip">
        <div className="flex items-center gap-3">
          ...
          <h2 className="font-serif text-xl">Daily Length-Retention Tip</h2>
        </div>
      ...
      <div className="mt-16 border-t border-foreground/15 pt-16" data-testid="action-plan">
        ...
        <p className="mt-5 max-w-3xl text-sm leading-relaxed text-foreground/75 md:text-base">
          Your strongest pattern is <strong className="font-medium text-foreground">{primaryCause}</strong>. The goal is not to add more products at once. It is to remove the stress caused by <strong className="font-medium text-foreground">{behaviorToStop}</strong>, establish a repeatable wash rhythm, and then judge the routine by how your scalp and lengths respond over time.
        </p>
        ...
        <div className="mt-10 rounded-3xl border border-foreground/15 bg-paper-dark p-6 md:p-10">
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-[0.85fr_1.15fr] md:gap-12">
            <div>
              <h3 className="font-serif text-2xl">What your answers showed</h3>
              <p className="mt-4 text-sm leading-relaxed text-foreground/80">
                Your result was supported by {observations.length > 1 ? `${observations[0]} and ${observations[1]}` : observations[0] || 'the pattern across your answers'}. Those signs make consistency and low-friction handling more important than chasing a single “growth” product.
              </p>
            </div>
            <div>
              <h3 className="font-serif text-2xl">What the plan is designed to do</h3>
              <ul className="mt-4 space-y-3 text-sm leading-relaxed text-foreground/80">
                <li><strong className="font-medium text-foreground">Clean consistently:</strong> Prevent residue and scalp oil from interfering with the conditioning and styling steps that follow.</li>
                <li><strong className="font-medium text-foreground">Protect the lengths:</strong> Reduce friction, rough detangling, repeated heat, and unnecessary handling of the oldest hair.</li>
                <li><strong className="font-medium text-foreground">Change one variable at a time:</strong> Introduce the routine in phases so you can tell which adjustment is helping or causing a problem.</li>
              </ul>
        ...
        <div className="mt-12">
          ...
          <h3 className="mt-3 font-serif text-3xl">The weekly schedule</h3>
          <p className="mt-4 max-w-2xl text-sm leading-relaxed text-foreground/75">
            Plan for <strong className="font-medium text-foreground">{washRhythm.toLowerCase()}</strong>. Use this sequence as the default, then follow the exact cadence printed on each product card.
          </p>
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            ...
            <div className="rounded-2xl border border-foreground/15 bg-paper p-6">
              ...
              {treatmentSteps.length > 0 ? (
                <div className="mt-3 space-y-3 text-sm leading-relaxed text-foreground/75">
                  ...
                  <p>Each treatment replaces its comparable regular step. Do not stack them in the same wash.</p>
                </div>
              ) : (
                <p className="mt-3 text-sm leading-relaxed text-foreground/75">
            ...
            <div className="rounded-2xl border border-foreground/15 bg-paper p-6">
              ...
              <h4 className="mt-3 font-serif text-xl">Protect, do not restart</h4>
              <p className="mt-3 text-sm leading-relaxed text-foreground/75">
                Preserve {styleLabel}, smooth only a small amount of oil over rough ends if needed, and avoid layering more products at the roots. Use the scalp step only at its listed cadence.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 rounded-3xl bg-sage/25 p-6 md:p-10">
          ...
          <div className="mt-8 grid gap-8 md:grid-cols-3">
            <div>
              ...
              <h4 className="mt-2 font-serif text-xl">Set the baseline</h4>
              <p className="mt-3 text-sm leading-relaxed text-foreground/75">Start with the cleanser, conditioner, leave-in, and the behavior change above. Take one photo of your ends and note scalp comfort, shedding during washing, tangling, and breakage.</p>
            </div>
            <div>
              <p className="text-[0.65rem] font-medium uppercase tracking-widest text-foreground/50">Days 8–14</p>
              <h4 className="mt-2 font-serif text-xl">Add targeted support</h4>
              <p className="mt-3 text-sm leading-relaxed text-foreground/75">If the core steps feel comfortable, add the scalp product and your scheduled mask or treatment. Patch test leave-on scalp products and stop if irritation develops.</p>
            </div>
            <div>
              <p className="text-[0.65rem] font-medium uppercase tracking-widest text-foreground/50">Days 15–30</p>
              <h4 className="mt-2 font-serif text-xl">Refine the amount</h4>
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2">
          <div>
            ...
            <div className="mt-6 space-y-5">
              ...
              <div className="border-l border-foreground/25 pl-5">
                ...
                <p className="mt-1 text-sm leading-relaxed text-foreground/75">Compare breakage, tangling, end texture, and how long your finished style lasts against your baseline notes.</p>
              </div>
              <div className="border-l border-foreground/25 pl-5">
                <h4 className="font-medium text-foreground">After 8–12 weeks</h4>
                <p className="mt-1 text-sm leading-relaxed text-foreground/75">Review photos taken in similar lighting and styling. Retention shows up as fuller-looking ends and less repeated breakage; growth rate itself may not visibly change.</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-6 space-y-4 text-sm leading-relaxed text-foreground/75">
              <p><strong className="font-medium text-foreground">Hair feels coated or limp:</strong> Reduce leave-in, styler, and oil amounts first. If residue persists, use the cleansing cadence in this guide rather than adding another treatment.</p>
              ...
              <p><strong className="font-medium text-foreground">Breakage is unchanged:</strong> Audit detangling, tension, heat, and nighttime friction before buying another product. Technique can cancel out an otherwise appropriate routine.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-16 border-t border-foreground/15 pt-16">
        ...
        <div className="mt-10">
          ...
          <div>
            ...
            <h3 className="mt-3 font-serif text-3xl">Where to spend first</h3>
            <p className="mt-4 max-w-2xl text-sm leading-relaxed text-foreground/75">
              Start with these three products before expanding your routine. They give you the strongest foundation for the pattern identified in your results.
            </p>
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col">
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                      <span className="text-[0.65rem] font-medium uppercase tracking-widest text-foreground/50">
                        Priority {index + 1} / {step.product.category}
                      </span>
                    ...
                    <h4 className="mt-4 font-serif text-2xl leading-tight">{step.product.name}</h4>
                    <p className="mt-1 text-xs font-medium text-foreground/60">{step.product.brand}</p>
                    <p className="mt-5 text-sm leading-relaxed text-foreground/80">
                      <strong className="font-medium text-foreground">Why this comes first:</strong> {step.product.reason}
                    </p>
          ...
          <div className="mt-12 rounded-3xl border border-foreground/15 bg-sage/25 px-6 py-8 md:grid md:grid-cols-[11rem_1fr] md:gap-10 md:px-10 md:py-10">
            ...
            <div>
              <p className="mt-5 text-sm leading-relaxed text-foreground/80 md:mt-0">
                Avoid duplicate-purpose impulse buys that are not part of your plan:
              </p>
              <ul className="mt-4 space-y-3 text-sm leading-relaxed text-foreground/80">
                ...
                {!hasScrub && <li><strong className="font-medium text-foreground">Harsh clarifying scrubs:</strong> Your scalp pattern does not call for aggressive exfoliation.</li>}
                {!hasProtein && <li><strong className="font-medium text-foreground">Heavy protein treatments:</strong> Your results do not support adding a separate high-protein treatment.</li>}
                <li><strong className="font-medium text-foreground">Duplicate treatments:</strong> One product per purpose is enough; overlapping products add cost without giving the step a clearer job.</li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-6 rounded-3xl border border-foreground/15 bg-paper-dark px-6 py-8 md:grid md:grid-cols-[11rem_1fr] md:gap-10 md:px-10 md:py-10">
            ...
            <ul className="mt-5 space-y-3 text-sm leading-relaxed text-foreground/80 md:mt-0">
              ...
              <li><strong className="font-medium text-foreground">High heat with fresh chemical stress:</strong> Avoid adding intense hot-tool styling when the hair has just been chemically processed.</li>
              <li><strong className="font-medium text-foreground">More frequent treatment applications:</strong> Follow the cadence shown in your routine. Doing more does not make hair grow faster.</li>
            </ul>
          </div>
      ...
      <div className="mt-24 border-t border-foreground/15 pt-16">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          >
            <Filter size={14} />
            {showSavedOnly ? 'Show Full Routine' : `Saved Products (${savedProducts.length})`}
          </button>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative flex w-full shrink-0 flex-col items-center justify-center overflow-hidden rounded-2xl bg-white/70 p-6 mix-blend-multiply md:w-64">
                  <button
                    onClick={() => toggleSave(step.product.id)}
                  ...
                  <div className="mt-6 grid gap-6 md:grid-cols-2">
                    <div className="space-y-4">
                      <p className="text-sm leading-relaxed text-foreground/80">
                        <strong className="font-medium text-foreground">Why this is in your routine:</strong> {step.product.reason}
                      </p>
                      <p className="text-sm leading-relaxed text-foreground/80">
                        <strong className="font-medium text-foreground">How to use:</strong> {step.instruction}
                      </p>
                    ...
                    <div className="rounded-xl bg-paper-dark p-5">
                      <h4 className="font-serif text-lg">How it benefits your routine</h4>
